	...
	private class SwingAction_1 extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			if (textField.getText().equals("") || textField_1.getText().equals("")
				...
				try {
					Fachada.insertWord(textField.getText(), textField_1.getText(), textField_2.getText(), Perfil.word);
					textField.setText("");
					textField_1.setText("");
					textField_2.setText("");
